package com.p4indiafsm.features.logoutsync.presentation
...
import com.p4indiafsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.p4indiafsm.features.billing.api.AddBillingRepoProvider
import com.p4indiafsm.features.billing.model.AddBillingInputParamsModel
...
import com.p4indiafsm.features.dashboard.presentation.ReasonDialog
...
import com.p4indiafsm.features.document.model.AddEditDocumentInputParams
import com.p4indiafsm.features.document.model.DocumentAttachmentModel
...
import com.p4indiafsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.p4indiafsm.features.orderhistory.model.*
...
import com.p4indiafsm.features.quotation.model.AddQuotInputModel
import com.p4indiafsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.p4indiafsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.p4indiafsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.p4indiafsm.features.timesheet.model.AddTimeSheetInputModel
import com.p4indiafsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.p4indiafsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.p4indiafsm.features.viewAllOrder.model.AddOrderInputProductList
import com.p4indiafsm.mappackage.SendBrod
import com.p4indiafsm.widgets.AppCustomTextView
import com.p4indiafsm.MonitorService
import com.p4indiafsm.features.addshop.model.*
import com.p4indiafsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.p4indiafsm.features.addshop.presentation.ShopExtraContactReq
...
import com.p4indiafsm.features.login.model.GetConcurrentUserResponse
import com.p4indiafsm.features.returnsOrder.ReturnProductList
import com.p4indiafsm.features.returnsOrder.ReturnRequest
import com.p4indiafsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xp4indiafsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xp4indiafsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xp4indiafsmlogsample/log.zip").path);
