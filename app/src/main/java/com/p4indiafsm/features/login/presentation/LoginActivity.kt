package com.p4indiafsm.features.login.presentation
...
import com.p4indiafsm.app.AlarmReceiver.Companion.setAlarm
import com.p4indiafsm.app.domain.*
import com.p4indiafsm.app.utils.*
import com.p4indiafsm.app.utils.AppUtils.Companion.getCurrentTimeInMintes
import com.p4indiafsm.base.BaseResponse
import com.p4indiafsm.base.presentation.BaseActivity
import com.p4indiafsm.features.activities.api.ActivityRepoProvider
import com.p4indiafsm.features.activities.model.*
import com.p4indiafsm.features.addAttendence.FingerprintDialog
import com.p4indiafsm.features.addAttendence.SelfieDialog
import com.p4indiafsm.features.addshop.api.AddShopRepositoryProvider
import com.p4indiafsm.features.addshop.api.areaList.AreaListRepoProvider
import com.p4indiafsm.features.addshop.api.assignToPPList.AssignToPPListRepoProvider
import com.p4indiafsm.features.addshop.api.assignedToDDList.AssignToDDListRepoProvider
import com.p4indiafsm.features.addshop.api.typeList.TypeListRepoProvider
import com.p4indiafsm.features.addshop.model.*
import com.p4indiafsm.features.addshop.model.TypeListResponseModel
import com.p4indiafsm.features.addshop.model.assigntoddlist.AssignToDDListResponseModel
import com.p4indiafsm.features.addshop.model.assigntopplist.AssignToPPListResponseModel
...
import com.p4indiafsm.features.beatCustom.api.GetBeatRegProvider
import com.p4indiafsm.features.billing.api.billinglistapi.BillingListRepoProvider
import com.p4indiafsm.features.billing.model.BillingListResponseModel
...
import com.p4indiafsm.features.dashboard.presentation.api.dayStartEnd.DayStartEndRepoProvider
import com.p4indiafsm.features.dashboard.presentation.api.gteroutelistapi.GetRouteListRepoProvider
import com.p4indiafsm.features.dashboard.presentation.model.SelectedRouteListResponseModel
import com.p4indiafsm.features.dashboard.presentation.model.StatusDayStartEnd
import com.p4indiafsm.features.document.api.DocumentRepoProvider
import com.p4indiafsm.features.document.model.DocumentListResponseModel
import com.p4indiafsm.features.document.model.DocumentTypeResponseModel
import com.p4indiafsm.features.forgotpassword.presentation.ForgotPasswordDialog
import com.p4indiafsm.features.location.LocationWizard
import com.p4indiafsm.features.location.SingleShotLocationProvider
import com.p4indiafsm.features.location.UserLocationDataEntity
...
import com.p4indiafsm.features.login.UserLoginDataEntity
import com.p4indiafsm.features.login.api.LoginRepositoryProvider
import com.p4indiafsm.features.login.api.alarmconfigapi.AlarmConfigRepoProvider
import com.p4indiafsm.features.login.api.global_config.ConfigFetchRepoProvider
import com.p4indiafsm.features.login.api.productlistapi.ProductListRepoProvider
import com.p4indiafsm.features.login.api.user_config.UserConfigRepoProvider
import com.p4indiafsm.features.login.model.*
import com.p4indiafsm.features.login.model.alarmconfigmodel.AlarmConfigResponseModel
import com.p4indiafsm.features.login.model.globalconfig.ConfigFetchResponseModel
import com.p4indiafsm.features.login.model.mettingListModel.MeetingListResponseModel
import com.p4indiafsm.features.login.model.productlistmodel.ModelListResponse
import com.p4indiafsm.features.login.model.productlistmodel.NewOdrScrOrderListModel
import com.p4indiafsm.features.login.model.productlistmodel.ProductListOfflineResponseModelNew
import com.p4indiafsm.features.login.model.productlistmodel.ProductListResponseModel
import com.p4indiafsm.features.login.model.userconfig.UserConfigResponseModel
import com.p4indiafsm.features.meetinglist.api.MeetingRepoProvider
import com.p4indiafsm.features.member.api.TeamRepoProvider
import com.p4indiafsm.features.member.model.TeamAreaListResponseModel
import com.p4indiafsm.features.member.model.UserPjpResponseModel
import com.p4indiafsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.p4indiafsm.features.nearbyshops.model.*
import com.p4indiafsm.features.newcollection.model.NewCollectionListResponseModel
import com.p4indiafsm.features.newcollection.model.PaymentModeResponseModel
import com.p4indiafsm.features.newcollection.newcollectionlistapi.NewCollectionListRepoProvider
import com.p4indiafsm.features.orderList.api.neworderlistapi.NewOrderListRepoProvider
import com.p4indiafsm.features.orderList.model.NewOrderListResponseModel
import com.p4indiafsm.features.orderList.model.ReturnListResponseModel
import com.p4indiafsm.features.quotation.api.QuotationRepoProvider
import com.p4indiafsm.features.quotation.model.BSListResponseModel
import com.p4indiafsm.features.quotation.model.QuotationListResponseModel
import com.p4indiafsm.features.stock.api.StockRepositoryProvider
import com.p4indiafsm.features.stock.model.NewStockListResponseModel
import com.p4indiafsm.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.p4indiafsm.features.stockAddCurrentStock.model.CurrentStockGetData
import com.p4indiafsm.features.stockCompetetorStock.api.AddCompStockProvider
import com.p4indiafsm.features.stockCompetetorStock.model.CompetetorStockGetData
import com.p4indiafsm.features.task.api.TaskRepoProvider
import com.p4indiafsm.features.task.model.TaskListResponseModel
import com.p4indiafsm.features.timesheet.api.TimeSheetRepoProvider
import com.p4indiafsm.features.timesheet.model.TimeSheetConfigResponseModel
import com.p4indiafsm.features.timesheet.model.TimeSheetDropDownResponseModel
import com.p4indiafsm.features.viewAllOrder.api.OrderDetailsListRepoProvider
import com.p4indiafsm.features.viewAllOrder.model.NewOrderDataModel
import com.p4indiafsm.features.viewPPDDStock.api.stocklist.StockListRepoProvider
import com.p4indiafsm.features.viewPPDDStock.model.stocklist.StockListDataModel
import com.p4indiafsm.features.viewPPDDStock.model.stocklist.StockListResponseModel
    ...
    private fun getMeetingList() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.meetingList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.p4indiafsm.features.meetinglist.model.MeetingListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
    ...
    private fun getTypeApi() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.typeList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.p4indiafsm.features.activities.model.TypeListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
                                val list = response.type_list
    ...
    fun openShareDB(dbpath:String) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                currentDBPath="/data/user/0/com.p4indiafsm/databases/fts_db"
            }
